    ...
    public partial class Form1 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e) //долить заданный объем воды
        {
            if (wvol.Text != "")
            {
                ...
                {//проверка на возможность долить заданный объем воды в 1 аквариум
                    ...
                    {
                        double w_vol = aq1.Water_in(Convert.ToDouble(wvol.Text));
                        l1.Text = Convert.ToString(Math.Round(aq1.L,2)); //новый уровень воды
                        listBox1.Items.RemoveAt(1);
                        listBox1.Items.Insert(1, "Объем налитой жидкости: " + Convert.ToString(w_vol));
                        listBox1.Items.RemoveAt(2);
                        listBox1.Items.Insert(2, "Заполненность: " + Convert.ToString(Math.Round(w_vol / aq1.Size() * 100, 2)) + "%");
                    }
                ...
                {//проверка на возможность долить заданный объем воды во 2 аквариум
                    ...
                    {
                        double w_vol = aq2.Water_in(Convert.ToDouble(wvol.Text));
                        l2.Text = Convert.ToString(Math.Round(aq2.L,2)); //новый уровень воды
                        listBox2.Items.RemoveAt(1);
                        listBox2.Items.Insert(1, "Объем налитой жидкости: " + Convert.ToString(w_vol));
                        listBox2.Items.RemoveAt(2);
                        listBox2.Items.Insert(2, "Заполненность: " + Convert.ToString(Math.Round(w_vol / aq2.Size() * 100, 2)) + "%");
                    }
        ...
        { 
            if (wvol.Text != "")
            {
                ...
                {//проверка на возможность вылить заданный объем воды из 1 аквариума
                    ...
                    {
                        double w_vol = aq1.Water_out(Convert.ToDouble(wvol.Text));
                        l1.Text = Convert.ToString(Math.Round(aq1.L,2)); //новый уровень воды
                        listBox1.Items.RemoveAt(1);
                        listBox1.Items.Insert(1, "Объем налитой жидкости: " + Convert.ToString(w_vol));
                        listBox1.Items.RemoveAt(2);
                ...
                else if (radioButton2.Checked) //вылить из 2
                {
                    ...
                    {
                    double w_vol = aq2.Water_out(Convert.ToDouble(wvol.Text));
                    l2.Text = Convert.ToString(Math.Round(aq2.L,2)); //новый уровень воды
                    listBox2.Items.RemoveAt(1);
                    listBox2.Items.Insert(1, "Объем налитой жидкости: " + Convert.ToString(w_vol));
                    listBox2.Items.RemoveAt(2);
        ...
        private void button4_Click(object sender, EventArgs e) //перелить все
        {
            ...
            if (radioButton3.Checked)//1->2
            {
                ...
                {
                    double n_v = aq2.Transfuse_all(aq1, aq2);
                    listBox2.Items.RemoveAt(1);
                ...
                if (radioButton4.Checked)
                {
                    ...
                    {
                        double n_v = aq1.Transfuse_all(aq2, aq1);
                        listBox1.Items.RemoveAt(1);
